        ...
        <div class="content">
            ...
            <h1>Trainer Updation Form</h1>
                    ...
                    <div class="user-container">
                        ...
                        <input type="text" id="lname" name="lname" size="20" value="<?php echo "$lastname"; ?>" onkeydown="move(event,'phone_number')" required/><br><br>
                        <label>Ph No:</label>
                        <input type="text" id="c_code" size="1" value="+91"/>
                        <input type="number" id="phone_number1" name="phone_number1"size="11"  value="<?php echo "$phone_number"; ?>" onkeydown="move(event,'email')" required/><br><br>
